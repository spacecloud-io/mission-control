...
import {
  ...
  getEventingSecurityRule,
  saveEventingSecurityRule,
} from "./eventing";
import {
  loadFileStoreRules,
  getFileStoreSecurityRule,
  saveFileStoreSecurityRule,
} from "./fileStore";
import {
  loadRemoteServices,
  getRemoteEndpointSecurityRule,
  saveRemoteServiceEndpointRule,
} from "./remoteServices";
import {
  loadIngressRoutes,
  getIngressRouteSecurityRule,
  getIngressRouteURL,
  saveIngressRouteRule,
} from "./ingressRoutes";
...
export const getSecurityRuleInfo = (state, ruleType, id, group) => {
  switch (ruleType) {
    ...
    case securityRuleGroups.REMOTE_SERVICES:
      return {
        rule: getRemoteEndpointSecurityRule(state, group, id),
        name: id,
      };
    case securityRuleGroups.INGRESS_ROUTES:
