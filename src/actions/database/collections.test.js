...
describe("save schema", () => {
  ...
  it("should handle usual flow and dbCollections already has collection in it", () => {
    const initialState = {
      dbSchemas: {},
      dbCollections: {
        mydb: [
...
describe('save rules', () => {
  it("should handle usual flow", () => {
    ...
    return store.dispatch(saveColRule('MockProject1', 'mydb', 'users', expectedRequestBody))
      .then(({ queued }) => {
