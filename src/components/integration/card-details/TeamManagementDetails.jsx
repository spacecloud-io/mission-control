...
const TeamManagementDetails = (props) => {
  ...
  return (
    <Card bordered style={{ boxShadow:'0px 2px 4px rgba(0, 0, 0, 0.25)' }}>
      ...
      {!Props.install && <Button type='primary' style={{ width:'100%' }} onClick={() => history.push(``)}>Install</Button>}
      {props.install && <Button type='primary' style={{ width:'100%' }}>Open console</Button>}
    </Card>
  );
}
