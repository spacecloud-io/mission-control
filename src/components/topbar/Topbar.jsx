...
const Topbar = (props) => {
  ...
  const content = (
    <div className="popContent">
      <p style={{ marginBottom: "50px", fontWeight: "bold", fontSize: "16px" }}>
        Love Space Cloud? Help us spread the love!
      </p>
      <Row align="middle">
        ...
        <Col md={{ span: 12, offset: 0 }}>
          <a
            href=" https://twitter.com/intent/tweet?text=Just%20deployed%20%23SpaceCloud%20-%20an%20opensource%20Firebase%20%2B%20Heroku!%20by%20%40SpaceUpTech.%0Ahttps%3A//github.com/spaceuptech/space-cloud%0A%23graphql%20%23webdev"
            target="_blank"
          >
            <img src={twitterIcon} />
            <p
      ...
      <div className="topbar">
        ...
        <div className="right-list">
          <Menu mode="horizontal">
            ...
            <Menu.Item>
              <a href="https://learn.spaceuptech.com/" target="_blank">
                Learn
              </a>
            </Menu.Item>
            <Menu.Item>
