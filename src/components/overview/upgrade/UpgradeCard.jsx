    ...
    <Card className="upgrade-card">
      <Row>
        ...
        <Col lg={{ span: 17, offset: 1 }} md={{ span: 12 }}>
          ...
          <p className="upgrade-content" >Avail all the exclusive features of Space Cloud for as low as $90/month</p>
          ...
          <Button type="primary" className="upgrade-btn" onClick={props.handleClickUpgrade} size="large">UPGRADE NOW - $90/month</Button>
        </Col>
      </Row>
    </Card>
  );
