        ...
        <Row className="select-plan">
            ...
            <Col lg={{ span: 7, offset:1 }}>
                <Card className="select-plan-card blue-card">
                    ...
                    {props.selectedPlan !== "pro" && <Button className="select-plan-button blue-button" onClick={props.handleChangePlan}>Use this plan</Button>}
                </Card>
            </Col>
            <Col lg={{ span: 7, offset:1 }}>
                <Card className="select-plan-card purple-card">
                    ...
                    {props.selectedPlan !== "team" && <Button className="select-plan-button purple-button" onClick={props.handleChangePlan}>Use this plan</Button>}
                </Card>
            </Col>
            <Col lg={{ span:23 }}>
