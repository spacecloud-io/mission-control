...
const AddAffinityForm = (props) => {
  ...
  const formInitialValues = {
    ...
    topologyKey: initialValues
      ? initialValues.topologyKey
      : "kubernetes.io/hostname",
    projects: initialValues ? initialValues.projects : [props.projectId],
    matchExpressions: initialValues
      ? initialValues.matchExpressions
      : [{ key: "", operator: "In", values: undefined }],
  };
  ...
  const handleSubmitClick = (e) => {
    form.validateFields().then((values) => {
      ...
      values.matchExpressions = values.matchExpressions.map((obj) =>
        Object.assign({}, obj, {
          attribute: "label",
          values:
            obj.operator === "Exists" || obj.operator === "DoesNotExist"
              ? []
              : obj.values,
        })
      );
        ...
        <Form layout="vertical" form={form} initialValues={formInitialValues}>
          <React.Fragment>
            ...
            <ConditionalFormBlock
              dependency="type"
              condition={() => form.getFieldValue("type") === "service"}
            >
              <FormItemLabel name="Topology key" />
              <Form.Item
                name="topologyKey"
                rules={[
                  { required: true, message: "Please enter topology key!" },
                ]}
              >
              ...
              >
                <Select mode="tags" placeholder="Projects">
                              ...
                              return (
                                ...
                                >
                                  <Select placeholder="Operator">
                                    ...
                                    <Select.Option value="DoesNotExist">
                                      DoesNotExist
                                    </Select.Option>
                                  </Select>
                                </Form.Item>
                              ...
                              <Col span={9}>
                                ...
                                <Tooltip
                                  title={
                                    showValues
                                      ? ""
                                      : "Values are not applicable for this operator"
                                  }
                                >
                                  <Form.Item
                                    {...field}
