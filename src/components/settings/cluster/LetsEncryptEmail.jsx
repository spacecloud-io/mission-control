...
const LetsEncryptEmail = ({ loading, letsEncryptEmail, handleSubmit }) => {
  ...
  return (
    <React.Fragment>
      ...
      <Form
        form={form}
        initialValues={{ letsEncryptEmail }}
      ...
      >
        ...
        <Form.Item
          shouldUpdate={(prev, curr) =>
            prev.letsEncryptEmail !== curr.letsEncryptEmail
          }
        >
          {() => {
            const valueChanged =
              letsEncryptEmail !== undefined &&
              form.getFieldValue("letsEncryptEmail") != letsEncryptEmail;
            return (
