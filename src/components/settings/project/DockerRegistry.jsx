...
const gcrRegionOptions = gcpRegions.map((region) => (
  <Option key={region} value={region}>
    {region}
  </Option>
));
const ecrRegionOptions = awsRegions.map((region) => (
  ...
  return (
    ...
    >
      <Form
        ...
        initialValues={{ registryType: "gcr" }}
      >
        <FormItemLabel name="Choose Registry Service" />
        <Form.Item
          name="registryType"
          rules={[
            { required: true, message: "Please select a registry service!" },
          ]}
        >
          <RadioCards>
        ...
        <ConditionalFormBlock
          ...
          condition={() => form.getFieldValue("registryType") === "gcr"}
        >
          ...
          >
            <Select placeholder="Select a region">{gcrRegionOptions}</Select>
          </Form.Item>
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please provide project id of your gcp project!",
              },
            ]}
          >
        ...
        <ConditionalFormBlock
          dependency="registryType"
          condition={() => form.getFieldValue("registryType") === "ecr"}
        >
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: "Please provide a region!" }]}
          >
            <Select placeholder="Select a region">{ecrRegionOptions}</Select>
          </Form.Item>
          <FormItemLabel name="AWS Account ID" />
          <Form.Item
            name="awsAccountId"
            rules={[
              { required: true, message: "Please provide your aws account id" },
            ]}
          >
        ...
        <ConditionalFormBlock
          dependency="registryType"
          condition={() => form.getFieldValue("registryType") === "acr"}
        >
          <FormItemLabel name="ACR Registry name" />
          <Form.Item
            name="acrRegistryName"
            rules={[
              { required: true, message: "Please provide your registry name" },
            ]}
          >
        ...
        <ConditionalFormBlock
          dependency="registryType"
          condition={() => form.getFieldValue("registryType") === "others"}
        >
          <FormItemLabel name="Docker Registry" />
          <Form.Item
            name="registryValue"
            rules={[
              { required: true, message: "Please provide your registry" },
            ]}
          >
