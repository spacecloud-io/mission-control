...
const GraphQLTimeout = ({ loading, contextTimeGraphQL = "", handleSubmit }) => {
  ...
  return (
    <div>
      ...
      <Form
        form={form}
        initialValues={{ contextTimeGraphQL: String(contextTimeGraphQL) }}
        onFinish={handleSubmitClick}
      >
        <Form.Item
          name="contextTimeGraphQL"
          rules={[
            {
        ...
        <Form.Item
          shouldUpdate={(prev, curr) =>
            prev.contextTimeGraphQL !== curr.contextTimeGraphQL
          }
        >
          {() => {
            const valueChanged =
              form.getFieldValue("contextTimeGraphQL") != contextTimeGraphQL;
            return (
