...
const EnableDBForm = ({
  ...
  const formInitialValues = {
    loadFromSecret:
      initialValues &&
      initialValues.conn &&
      initialValues.conn.startsWith("secrets.")
        ? true
        : false,
    conn:
      initialValues &&
      initialValues.conn &&
      initialValues.conn.startsWith("secrets.")
        ? defaultDbConnectionStrings[initialValues.db]
        : initialValues.conn,
    secret:
      initialValues &&
      initialValues.conn &&
      initialValues.conn.startsWith("secrets.")
        ? initialValues.conn.split(".")[1]
        : "",
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <Alert message={alertMsg} description=" " type="info" showIcon />
        </ConditionalFormBlock>
        <ConditionalFormBlock
          dependency="loadFromSecret"
