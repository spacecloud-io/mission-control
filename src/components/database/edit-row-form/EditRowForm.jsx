        ...
        values.rows.forEach((val, index) => {
          if (val.datatype === "array") {
            values.rows[index].value = val.arrays
              ? val.arrays.map((el) => el.value)
              : [];
          }
          if (val.datatype === "json" || !primitives.includes(val.datatype)) {
            values.rows[index].value = !json[index]
              ? undefined
                    ...
                    <Row key={field.key} gutter={10}>
                      <Col span={5}>
                        ...
                        >
                          <AutoComplete
                            ...
                            onBlur={(e) => {
                              const column = props.schema.find(
                                (val) => val.name === e.target.value
                              );
                              if (column) {
                                form.setFields([
                                  {
                                    name: ["rows", field.name, "datatype"],
                                    value: column.type.toLowerCase(),
                                  },
                                ]);
                              }
                            }}
                            ...
                            {props.schema
                              .filter(
                                (data) =>
                                  data.name
                                    .toLowerCase()
                                    .indexOf(columnValue.toLowerCase()) !== -1
                              )
                              .map((data) => (
                                <AutoComplete.Option
                                  key={data.name}
                      ...
                      <Col span={5}>
                        ...
                        >
                          ...
                          >
                            ...
                            <Select.Option value="multiply">
                              Multiply
                            </Select.Option>
                            <Select.Option value="min">Min</Select.Option>
                            <Select.Option value="max">Max</Select.Option>
                            <Select.Option value="currentDate">
                              Current Date
                            </Select.Option>
                          ...
                          >
                            <Col span={7}>
                              <Form.Item
                                ...
                                rules={[isFieldRequired(field.name)]}
                              >
                                <Input
                                  placeholder="value"
                                  suffix={
                      ...
                      <Col span={2}>
                        <Popconfirm
                          ...
                          cancelText="No"
                        >
                          <MinusCircleOutlined style={{ margin: "0 8px" }} />
                        </Popconfirm>
                      </Col>
                    </Row>
                    <ConditionalFormBlock
                      shouldUpdate={true}
                      condition={() =>
                        form.getFieldValue(["rows", field.name, "datatype"]) ===
                        "array"
                      }
                    >
                      <Form.Item
