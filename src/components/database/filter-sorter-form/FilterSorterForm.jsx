                          ...
                          <AutoComplete
                            ...
                            onBlur={(e) => {
                              ...
                              if (column) {
                                ...
                                form.setFields([
                                  {
                                    name: ["filters", field.name, "datatype"],
                                    value: column.isArray
                                      ? "array"
                                      : !primitives.includes(columnDataType)
                                      ? "json"
                                      : columnDataType,
                                  },
                                ]);
