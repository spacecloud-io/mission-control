...
export function makeServer({ environment = "development" } = {}) {
  let server = new Server({
    ...
    routes() {
      ...
      this.get("/config/projects/:projectId/database/:dbName/collections/:colName/schema/inspect", () => respondOk());
      this.post("/config/projects/:projectId/database/:dbName/schema/inspect", () => respondOk());
      this.post("/config/projects/:projectId/database/:dbName/collections/:colName/schema/inspect", () => respondOk({ result: "type users{ id: ID! @primary email: ID! name: String! pass: String! role: String! newField: String! }" }));
